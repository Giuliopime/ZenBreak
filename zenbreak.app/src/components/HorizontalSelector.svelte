...
<div class="relative">
    <div class="flex border-2 border-secondary rounded-full -z-100">
        {#each platforms as p, i (i)}
            <button class="rounded-full hover:bg-secondary px-4 py-2 cursor-pointer transition-all"
    ...
    <button
            ...
            class="absolute border-primary border-2 top-0 z-10 rounded-full px-4 py-2 text-transparent cursor-default transition-all">
